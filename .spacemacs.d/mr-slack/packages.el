...
(defun mr-slack/post-init-emoji-cheat-sheet-plus ()
  (add-hook 'slack-mode-hook 'emoji-cheat-sheet-plus-display-mode))

(defun mr-slack/post-init-flyspell ()
...
(defun mr-slack/post-init-smooth-scrolling ()
